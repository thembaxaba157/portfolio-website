...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h1 className="home__title">Themba Xaba
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> A passionate software developer based in Johannesburg 
            dedicated to building efficient, scalable, and innovative
            solutions.</p>
